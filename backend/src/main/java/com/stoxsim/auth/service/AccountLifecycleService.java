...
public class AccountLifecycleService {
    ...
    public Map<String, Object> exportAccount(UUID userId) {
        ...
        export.put("testBilling", jdbcTemplate.queryForList("SELECT id,plan,provider_id,status,current_period_end,paid_count,benefits_enabled,benefit_status,access_until,paid_through,created_at FROM razorpay_test_subscription WHERE user_id=? ORDER BY created_at", userId));
