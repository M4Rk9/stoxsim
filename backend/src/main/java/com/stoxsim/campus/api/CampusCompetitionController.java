...
public class CampusCompetitionController {
    ...
    @PostMapping("/institutions/{institution}/competitions/{competition}/refresh") public ResponseEntity<Board> refresh(@AuthenticationPrincipal Jwt jwt,@PathVariable UUID institution,@PathVariable UUID competition) { return ok(service.refreshBoard(id(jwt),institution,competition)); }
